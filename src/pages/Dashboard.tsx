...
const Dashboard = () => {
  ...
  const [stateChangeLog] = useState([
    { id: 1, aircraftName: "Aircraft 1", state: "Landed", date: "2024-04-09", time: "10:30:00", callSign: "NC9574" },
    { id: 2, aircraftName: "Aircraft 2", state: "Departed", date: "2024-04-09", time: "10:35:00", callSign: "NC1004" },
    { id: 3, aircraftName: "Aircraft 3", state: "Parked", date: "2024-04-09", time: "10:40:00", callSign: "NC2342" },
    { id: 4, aircraftName: "Aircraft 4", state: "Airborne", date: "2024-04-09", time: "10:45:00", callSign: "NC3456" },
    { id: 5, aircraftName: "Aircraft 5", state: "Approach", date: "2024-04-09", time: "10:50:00", callSign: "NC4567" },
    { id: 6, aircraftName: "Aircraft 6", state: "Landed", date: "2024-04-09", time: "10:55:00", callSign: "NC5678" },
    { id: 7, aircraftName: "Aircraft 7", state: "Parked", date: "2024-04-09", time: "11:00:00", callSign: "NC6789" },
    { id: 8, aircraftName: "Aircraft 8", state: "Take-Off", date: "2024-04-09", time: "11:05:00", callSign: "NC7890" },
    { id: 9, aircraftName: "Aircraft 9", state: "Airborne", date: "2024-04-09", time: "11:10:00", callSign: "NC8901" },
    { id: 10, aircraftName: "Aircraft 10", state: "Approach", date: "2024-04-09", time: "11:15:00", callSign: "NC9012" },
  ]);
        ...
        <div className="col-md-4 mb-4">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p><strong>Runways:</strong> {runways}</p>
              <p><strong>Airliner Parking Spots:</strong> {parkingSpots.airliners}</p>
              <p><strong>Private Aircraft Parking Spots:</strong> {parkingSpots.private}</p>
            </div>
          </div>
        </div>
        <div className="col-md-4 mb-4">
          <div className="card">
            <div className="card-header">
              <h3>Last Fetched Weather Data</h3>
            </div>
            <div className="card-body">
